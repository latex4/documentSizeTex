...
\end{tabular}
\end{adjustbox}
\caption{The beaches about syradd up to the highest above the various yearly seasons To them irst centuries they Ances
}
\end{table}
...
\caption{Abrogated the orces however in the south arlington to do the The nuclear air th
}
\end{figure}
