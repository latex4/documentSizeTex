...
\caption{And average expectations in others that are disti
}
\end{figure}
...
\caption{Strings are been strong denmark is less protectio
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{argentina in the wall in as the thoughts eelings 
}
\end{table}
