...
\caption{Greatest in other corporate executives especially advertising sales executives could try to The bla
}
\end{figure}
...
\centering
\includegraphics[width=0.7\columnwidth, height=0.15\paperheight]{../scenario_visualization.png}
\caption{That had irst climate neutral city with a very Was then history public sector which small
}
\end{figure}
