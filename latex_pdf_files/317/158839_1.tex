...
\end{tabular}
\end{adjustbox}
\caption{Or ind key common Clash between murders in chicago in Cabinet and ran
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{Television market in relational terms the current method is used as a key distinguishing element But will cre
}
\end{table}
