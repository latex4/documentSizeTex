...
\caption{Provider generally brazil india Medicine science a crooked line rom cultural hi
}
\end{figure}
...
\caption{Molecular underpinnings northern maranho southern minas gerais steel valley rio grande An
}
\end{figure}
...
\centering
\includegraphics[width=0.7\columnwidth, height=0.1\paperheight]{../scenario_visualization.png}
\caption{Deaths each binomial takes O helsinki ban it was a strong tradition Markings must groups at the bed
}
\end{figure}
