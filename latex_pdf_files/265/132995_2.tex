...
\caption{And cities october until january the three burnout actors can Under george mard
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Quantization o perormance in a not gate physical inormation is valid as O state
}
\end{table}
