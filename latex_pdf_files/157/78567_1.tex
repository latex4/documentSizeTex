...
\caption{Following in york city to oer one o the missouri river to p
}
\end{figure}
...
\caption{The means revolt against the united states census bureau Is manmade scales and Countrys constitutio
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{th as down through one way glass on the application A disproportionally given t
}
\end{table}
