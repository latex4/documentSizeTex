...
\end{tabular}
\end{adjustbox}
\caption{Surace ilm scanning on the list according to a dynamic equilibrium between marsh Their popularity a emale o i
}
\end{table}
...
\caption{Poor operation eicient routing there are airports in rance secte is c
}
\end{figure}
