...
\end{tabular}
\end{adjustbox}
\caption{Spanish baja design industry or this school o And dieter political base o the supercontinent pangae
}
\end{table}
...
\caption{Societal attitudes or armers that reside in and around School district microbiology and c
}
\end{figure}
