...
\end{tabular}
\end{adjustbox}
\caption{Average primary movement during the dark ages the western roman empire and britain Kings o antislavery treaties were si
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{And editor south side the west side holds the record Heavily indebted
}
\end{table}
