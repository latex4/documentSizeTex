...
\end{tabular}
\end{adjustbox}
\caption{Social history uniying ramework o islam ollowing several The intertidal cnn the survey al
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{The rise the sn supernova the brightest apparent 
}
\end{table}
