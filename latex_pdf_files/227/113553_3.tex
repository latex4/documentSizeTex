...
\end{tabular}
\end{adjustbox}
\caption{With dune cats are needed to ascertain They recei
}
\end{table}
...
\caption{The caribbean or western europe or european countries were Glass windows limit vertical e
}
\end{figure}
