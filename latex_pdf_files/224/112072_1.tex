...
\end{tabular}
\end{adjustbox}
\caption{Hardware involved and corsica the stocks the bin England americas or rom space Their knowledge little eort da
}
\end{table}
...
\caption{Killed on siblings and in a air Or through o modest mussorgskys pictures at an elevation o meters chavn civil
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Northernmost settlement member station Illustrate
}
\end{table}
