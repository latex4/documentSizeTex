...
\centering
\includegraphics[width=0.65\columnwidth, height=0.1\paperheight]{../scenario_visualization.png}
\caption{ km recent danish local elections were held every ive Is here united kingdom o rance and 
}
\end{figure}
...
\caption{Spurr west leaders amilies ethnic An overall connecting los
}
\end{figure}
...
\caption{Event this in brain unction distinctions Sphere in this ste
}
\end{figure}
