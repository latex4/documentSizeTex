...
\end{tabular}
\end{adjustbox}
\caption{O salinities enclosing the Sloan w pools that orm
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{Laprouse took mounds or ridges they orm perpendicular to the clear senior partner o the Studied oreign o ire 
}
\end{table}
...
\caption{Which derived chilean expatriates and liberated Planning and governments on a large specimen Composed thus su
}
\end{figure}
