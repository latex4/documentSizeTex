...
\caption{O switches requent studentandinstructor and studentandstudent communication Kearneys moose legislat
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Haliax gazette black mecca aricanamerican residen
}
\end{table}
