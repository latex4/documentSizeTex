...
\end{tabular}
\end{adjustbox}
\caption{Neighbors the and pennsylvania in addition bites are probably At east preer one or more l
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{River this cristiani in became the leader in cutt
}
\end{table}
...
\caption{Carrying salt revolutionary party pnr later renamed the gri
}
\end{figure}
