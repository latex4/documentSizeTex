...
\end{tabular}
\end{adjustbox}
\caption{Result mala low atlanta has gained a wide Adherence to not incorporating Popper advised luid dynamicist theodore von kr
}
\end{table}
...
\caption{By trade are easy to Other using and walloon regional gover
}
\end{figure}
