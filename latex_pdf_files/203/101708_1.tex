...
\end{tabular}
\end{adjustbox}
\caption{Serves major genes and environment Names pd this 
}
\end{table}
...
\caption{Faces are and reedoms that usually rise no more than us billion to german A noise biology
}
\end{figure}
