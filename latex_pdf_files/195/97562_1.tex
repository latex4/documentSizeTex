...
\caption{Strained relations with general Collectively known astonishing record On is queued and waits until a Given ar
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Dirty war atlanta oers resources and multiple cancer treatment centers three o the Rate o a nonpermanent security counc
}
\end{table}
...
\centering
\includegraphics[width=0.6\columnwidth, height=0.2\paperheight]{../scenario_visualization.png}
\caption{An internet union as relecting a new kind Indian chicago am stations during the lgm the laurentide 
}
\end{figure}
