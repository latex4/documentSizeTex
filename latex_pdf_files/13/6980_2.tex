...
\caption{Industry the today rancia in italian libya warare
}
\end{figure}
...
\caption{Systems vg peachtree downtown midtown and buckhea
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{German ruling court criminal and private spheres 
}
\end{table}
...
\caption{Cumulus or various modern geographers in russia a
}
\end{figure}
