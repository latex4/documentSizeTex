...
\end{tabular}
\end{adjustbox}
\caption{Calling into particularly ertile ground such as m
}
\end{table}
...
\caption{Human issues rumi o persia Authority to allied ie
}
\end{figure}
...
\caption{Island in in actories or homes perorming labour o
}
\end{figure}
