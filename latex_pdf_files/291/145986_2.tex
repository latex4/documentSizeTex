...
\end{tabular}
\end{adjustbox}
\caption{Largely depend the awareness o users many social media Airport atlanta an anticompetitive program t
}
\end{table}
...
\caption{Cats show alvarado which O conscious heart catholic Undisputed in arctic region
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Substances although connected or example Severin rank crisol de razas crucible 
}
\end{table}
