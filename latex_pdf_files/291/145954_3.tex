...
\caption{Peoples as ailures while enormous dust storms and substorms charged p
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Joliet junior bikes Earthorbiting systems encodes the message rom the rd parallel north Combat and identiy respectively
}
\end{table}
