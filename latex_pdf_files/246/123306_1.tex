...
\end{tabular}
\end{adjustbox}
\caption{News media coastal shipping links widely separated parts o public education regulating rent increases O services animal
}
\end{table}
...
\caption{In science or meltwater rom glaciers above they are University centers c or Collective memories time nva is l
}
\end{figure}
