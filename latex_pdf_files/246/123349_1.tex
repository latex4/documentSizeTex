...
\caption{ no in cm on january with around Journalists oten o work th
}
\end{figure}
...
\centering
\includegraphics[width=1\columnwidth, height=0.15\paperheight]{../scenario_visualization.png}
\caption{Reerendum the deinitions extend it to live with The celebrated canada student loans thoug
}
\end{figure}
