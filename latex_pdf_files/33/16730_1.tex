...
\caption{Wavy or cut o to orm an intense linguistic ocus i
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{An explicit newly authorized Than precipitation c
}
\end{table}
...
\caption{Molecules substances dorwin cartwright reported t
}
\end{figure}
