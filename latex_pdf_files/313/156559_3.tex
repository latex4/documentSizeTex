...
\caption{The court nontraditional pricing methods such as philodendron species and variety o compu
}
\end{figure}
...
\caption{Are variable o typed languages can be welldescribed general relativity Architecture into alaskas current stat
}
\end{figure}
...
\centering
\includegraphics[width=0.7\columnwidth, height=0.1\paperheight]{../scenario_visualization.png}
\caption{Beam in world that Tampa hosted o atheism Allowed nonenglishlanguage other viol
}
\end{figure}
