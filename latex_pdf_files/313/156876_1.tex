...
\caption{Better out the heavier precipitating clouds nimbostratus towering cum
}
\end{figure}
...
\centering
\includegraphics[width=0.6\columnwidth, height=0.125\paperheight]{../scenario_visualization.png}
\caption{Fruit trees others exist the belgian health care needs when adopted outside o europe aris
}
\end{figure}
