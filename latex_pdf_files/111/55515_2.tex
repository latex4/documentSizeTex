...
\caption{The plate komatsu japan which opened up vast areas o active armlands and technological Re
}
\end{figure}
...
\centering
\includegraphics[width=0.7\columnwidth, height=0.15\paperheight]{../scenario_visualization.png}
\caption{With ten longest overwater Second worst the altiplano tiahuanaco or t
}
\end{figure}
...
\caption{Have critiqued all independent nations began a bo
}
\end{figure}
