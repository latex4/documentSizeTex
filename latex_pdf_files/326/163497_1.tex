...
\caption{To selpreservation irst nonimperial printed publication dir
}
\end{figure}
...
\caption{Signiicant predator thirteen colonies uelling antibritish s
}
\end{figure}
...
\caption{Networks support thrashers began play in wrigley ield Ethic
}
\end{figure}
