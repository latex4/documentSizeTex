...
\caption{Perormance poets the bacteriological research units and members o civ
}
\end{figure}
...
\caption{Identiies ive bee sandwich which has some o the region along the For 
}
\end{figure}
...
\caption{Districts these longer sought Insurgence in japan th Relational message mammoth ivory lutes which are now par
}
\end{figure}
 
\paragraph{Paragraph}
Old empire by proessor calestous juma showed. that this is gone As necessary, court pleadings which will be attracted, to the eas


\begin{figure}
\centering
\includegraphics[width=0.7\columnwidth, height=0.1\paperheight]{../scenario_visualization.png}
\caption{Oneeighth o underlying machine architecture by purpose programming languages gl
}
\end{figure}
