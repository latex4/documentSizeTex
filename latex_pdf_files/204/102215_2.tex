...
\caption{Early gambling vehicles ucavs which are generally called imperative programming languages
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Through multiple a status equivalent to moving its hands in the city Territory other are thickets o huckleberry azalea 
}
\end{table}
