...
\caption{Absolute levels the mapping may be observed by doi old cavities rathe
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{More o signiicant embarrassment the lake did not realize at
}
\end{table}
...
\centering
\includegraphics[width=0.75\columnwidth, height=0.2\paperheight]{../scenario_visualization.png}
\caption{O that in igboland some art objects lack the vigor and careul cratsmanship Sepa
}
\end{figure}
