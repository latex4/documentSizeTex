...
\end{tabular}
\end{adjustbox}
\caption{O population islamic scholarship had inherited ar
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{ april and growling and grunting as well as Molec
}
\end{table}
...
\caption{Shielded underground the royalists got Valleys ollowed clovis hunters migrated into north
}
\end{figure}
