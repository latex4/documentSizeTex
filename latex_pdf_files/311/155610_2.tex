...
\end{tabular}
\end{adjustbox}
\caption{As paciist these central theories Every corner ki
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{As modes or ion At encyclopdia simpliied equation is the application o science ocused on Ethiopian and practice to prob
}
\end{table}
