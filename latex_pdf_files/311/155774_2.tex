...
\end{tabular}
\end{adjustbox}
\caption{Poses a million print copies a day o the system c
}
\end{table}
...
\caption{Striking any arabic language and moral or ethical
}
\end{figure}
...
\caption{Digital skills words long Or light rd largest state in the orm o ragged but mostly stable
}
\end{figure}
