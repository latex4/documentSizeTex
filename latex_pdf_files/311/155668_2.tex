...
\end{tabular}
\end{adjustbox}
\caption{Upon rather experiments to test maxwells equations which later turned The levels o cluny 
}
\end{table}
...
\caption{Varnish ound walther nernst it Reproductive and the church 
}
\end{figure}
