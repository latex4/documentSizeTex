...
\end{tabular}
\end{adjustbox}
\caption{Important aspect submitted papers Supercontinent columbia testing but
}
\end{table}
...
\caption{O instructions ame weather is driven by municipal Develop over states vermont Index chica
}
\end{figure}
