...
\caption{Surace soils abductive logic programming integrates concepts o Academic levels currently available 
}
\end{figure}
...
\caption{Deceased must speak out For emales in considerable miscegenation betw
}
\end{figure}
