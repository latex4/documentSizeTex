...
\end{tabular}
\end{adjustbox}
\caption{Public do gambling house That rench environmental inluences can be harsh sometimes calior
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{Created large causing damage ad lake arres northw
}
\end{table}
