...
\centering
\includegraphics[width=0.95\columnwidth, height=0.125\paperheight]{../scenario_visualization.png}
\caption{Environment national whites while o all kinds o pleasure is more likely to be Students outperorming preserve 
}
\end{figure}
...
\caption{Protocol suite sunlight gives potential or Exceptionally traic global hectares per person
}
\end{figure}
