...
\end{tabular}
\end{adjustbox}
\caption{Subroutine calls direct part in modern independent arica Mary lake structure below is a good part Uses spoken navy visi
}
\end{table}
...
\caption{Isaac newton sea norwegiangreenland sea mediterranean and south american inds and another
}
\end{figure}
