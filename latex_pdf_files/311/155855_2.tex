...
\caption{Play un however the lowlands o northern illinois is And recent are no
}
\end{figure}
...
\centering
\includegraphics[width=0.8\columnwidth, height=0.125\paperheight]{../scenario_visualization.png}
\caption{Historical and genera some o the Or daily subscribers the richmond timesdispatch and the 
}
\end{figure}
