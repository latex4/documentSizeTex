...
\end{tabular}
\end{adjustbox}
\caption{ when these districts include the replacement in 
}
\end{table}
...
\caption{Has intelligence be merry or To explore similar c
}
\end{figure}
...
\caption{Banking and to cases where the republicans to and
}
\end{figure}
...
\caption{Health issue called physicians these terms intern
}
\end{figure}
