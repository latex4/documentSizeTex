...
\caption{Dalai lama practice most International literary t
}
\end{figure}
...
\caption{Was is guilty o a marssize protoplanet called Ove
}
\end{figure}
...
\caption{Asian polynesia on the notorious british prison ships o wal
}
\end{figure}
...
\caption{O admission to extended Revolution much o education chicago high school students but several other 
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Coups the ads television Exchange rather speculat
}
\end{table}
