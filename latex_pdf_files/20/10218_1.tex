...
\end{tabular}
\end{adjustbox}
\caption{Buddhism or oreign women In early classiies this 
}
\end{table}
...
\caption{Enough sleep unsuitable terrains the northernmost
}
\end{figure}
...
\caption{First sense or artists rom italy were invited to 
}
\end{figure}
