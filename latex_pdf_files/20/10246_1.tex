...
\caption{Networks within social media dier rom that Drople
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Basis degree programs such as acebook relationshi
}
\end{table}
...
\caption{Room o o users enterprises and content providers 
}
\end{figure}
