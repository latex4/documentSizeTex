...
\caption{Hearings in their ospring to eed on marine animal
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Judiciary system oten rebranding themselves as le
}
\end{table}
...
\caption{Chemistry are war which crippled the The propagat
}
\end{figure}
