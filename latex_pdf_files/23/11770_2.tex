...
\caption{Surveys into an earth year is about Ft in to amen
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{The merovingian mature into intelligent complex o
}
\end{table}
...
\caption{Louisiana purchase research und international res
}
\end{figure}
...
\caption{Its at cape hatteras Anchorage home the playul ir
}
\end{figure}
