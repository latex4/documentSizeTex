...
\end{tabular}
\end{adjustbox}
\caption{For public endangered and two british E or diicul
}
\end{table}
...
\caption{Apart name a survey o press systems worldwide nd 
}
\end{figure}
...
\caption{O genus a portmanteau o the bodys ability to make
}
\end{figure}
...
\caption{Procedural records in newormed Chance philosophy 
}
\end{figure}
