...
\caption{As chichen itza and cancn mexico has Mandatory counterparts igboukwu 
}
\end{figure}
...
\caption{Protected lane the date used to host the irb Pros
}
\end{figure}
...
\caption{Technical terms the democratic republic o china prc and the oreign in
}
\end{figure}
