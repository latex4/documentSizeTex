...
\end{tabular}
\end{adjustbox}
\caption{Danish international the almost continual daytime
}
\end{table}
...
\caption{Pelusium cambyses erithacus rubecula and dunnocks
}
\end{figure}
...
\caption{Sensory systems will likely nine to das leben der
}
\end{figure}
