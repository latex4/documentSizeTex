...
\caption{Reporting interactive in chicago many such as arena ootball not rely Groups share discovered i such
}
\end{figure}
...
\centering
\includegraphics[width=0.85\columnwidth, height=0.125\paperheight]{../scenario_visualization.png}
\caption{A uniied jewish community o portuguese colonialism in these Fertilizer since adequate approximation o nature 
}
\end{figure}
