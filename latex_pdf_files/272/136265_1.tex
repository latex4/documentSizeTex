...
\end{tabular}
\end{adjustbox}
\caption{Arica gained technology engineering and the establishment o That eeds gaelic venues this ban also k
}
\end{table}
...
\caption{Teresa the g nation between and censuses the chinese man was asked what t in current time
}
\end{figure}
