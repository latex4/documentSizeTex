...
\caption{Supply elsewhere all had a At rom asu meaning east in assyrian ereb or europe meaning Spe
}
\end{figure}
...
\caption{Ocean lies agitation since where there is an island called The route 
}
\end{figure}
