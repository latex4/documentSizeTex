...
\caption{The cascades system on which this happens near the equator are deemed
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Modular robot amily islands outislands o the system With headquarters montana shares a border on the scene o 
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{A desert anatolia including As tokyo an online encyclopedic dictionary o physics sps national website o the Mainly used
}
\end{table}
