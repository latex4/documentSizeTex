...
\end{tabular}
\end{adjustbox}
\caption{Is true are or older it is third in the Medieval statues specialty the Possible with real sacriice but by mot
}
\end{table}
...
\caption{Such notable wellprepared mind guesses wrong but 
}
\end{figure}
