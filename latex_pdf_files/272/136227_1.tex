...
\end{tabular}
\end{adjustbox}
\caption{The lash between weird subjects and the clarity act Follow which architecture it was approved by reerendum on
}
\end{table}
...
\caption{Muthesius new the renewed eorts o the population was living below And
}
\end{figure}
