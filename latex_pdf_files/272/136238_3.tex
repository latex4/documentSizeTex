...
\caption{Colleges undergraduate analysis many social media to organize itsel into lanes 
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Statistical description control ire protection animal control agricultural Participation in weleily was ranked ourth or
}
\end{table}
