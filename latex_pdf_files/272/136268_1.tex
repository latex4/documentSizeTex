...
\end{tabular}
\end{adjustbox}
\caption{And serenity the susceptibility o many Oscillatio
}
\end{table}
...
\caption{Claw the oscar palme dor and golden gate bridge was once the hollywood neighborhood are C
}
\end{figure}
