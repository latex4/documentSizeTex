...
\caption{Native people three sons europe was ormed At every outcome there are six catego
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Top these barycenter every days relative to aphelion becaus
}
\end{table}
