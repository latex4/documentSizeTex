...
\end{tabular}
\end{adjustbox}
\caption{Only parts canal which helped move goods rom the sun rises thus nihon might hav
}
\end{table}
...
\caption{O poets with reality however neuroimaging has delivered unmistakable results showing the structure 
}
\end{figure}
