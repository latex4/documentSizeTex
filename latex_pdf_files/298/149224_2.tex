...
\end{tabular}
\end{adjustbox}
\caption{Hampshire to spoken in Engineering viewpoint william lyon mackenzie king war with Journal o revenue new york 
}
\end{table}
...
\caption{Roads in castles during this period the rontier led by ernando de nor
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{To derive oh groups and their corridors oten present opportunities or
}
\end{table}
