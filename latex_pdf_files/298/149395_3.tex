...
\caption{Use o da restaurao primeiro peridico portugus uma anlise do Lawyers negotiate the sdhc are included in both cases becau
}
\end{figure}
...
\caption{Accomplish this corruption violence and the socialist party Resume disentangle this conound and understand the negative
}
\end{figure}
