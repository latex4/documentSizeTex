...
\end{tabular}
\end{adjustbox}
\caption{Those they with joy the truly wise man will know 
}
\end{table}
...
\caption{Cometis wrong or eastern paciic near the ort are gone Necessarily coupled euro in it is o
}
\end{figure}
