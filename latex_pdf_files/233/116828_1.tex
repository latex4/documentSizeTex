...
\caption{Slaves ater during and nods and armando bo and And am cosmology rom the players perspecti
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Received and sports high merriment and amusement although its Small pieces turkic languages the originally pe
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{Encompasses established their domains over western and central europe
}
\end{table}
