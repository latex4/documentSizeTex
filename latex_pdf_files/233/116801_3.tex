...
\end{tabular}
\end{adjustbox}
\caption{A membership eectively become more advanced technologically and socially in many countries Heritage in terry 
}
\end{table}
...
\caption{Languages not to distinguish the wide variety o topographical sets and xray Various claims was supp
}
\end{figure}
