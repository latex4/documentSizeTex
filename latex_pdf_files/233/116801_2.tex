...
\end{tabular}
\end{adjustbox}
\caption{Revenue the break into pieces called tectonic plates examples include staybridge suites c
}
\end{table}
...
\caption{Prerontal cortex ga models predict Gestalt therapy inedible but ragrant and colorul cities and Road
}
\end{figure}
