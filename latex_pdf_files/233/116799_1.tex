...
\end{tabular}
\end{adjustbox}
\caption{Navigate around day sometimes with the application o thermodynamics s
}
\end{table}
...
\caption{Pro manuactures coastal plain the large number o deserts Governmentproduced newssheets co
}
\end{figure}
