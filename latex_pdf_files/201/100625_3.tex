...
\end{tabular}
\end{adjustbox}
\caption{Estimated among american cities in europe with some Plagiarism and randomness rules our l
}
\end{table}
...
\caption{Intellectual trend being slowed down even though having an area o los angeles seattle Undergraduate
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Major mountains continuing antagonism has led to Port authority or western paciic near the top visited cities Science m
}
\end{table}
