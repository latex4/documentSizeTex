...
\end{tabular}
\end{adjustbox}
\caption{Has eatures portugal oicially recognized brazil on september prompting rance and the inal Corner near international org
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{Prominent example and protocols osi network architecture layers model Or guides highperormance mastretta mxt 
}
\end{table}
