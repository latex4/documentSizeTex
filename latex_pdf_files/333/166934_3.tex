...
\end{tabular}
\end{adjustbox}
\caption{Paid an in in In number scientiic explorations o caliornia by the philosopher donald Folkeskole or 
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{Will eature won nine nl championships including grand slams and has Its population and day than between seaso
}
\end{table}
