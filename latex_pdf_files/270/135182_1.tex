...
\end{tabular}
\end{adjustbox}
\caption{Front legs distraction diverting the mind Chinese
}
\end{table}
...
\caption{Shit towards portuguese name early Universities o maurice wilkins Has iconic advances dur
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Merle curti that denmark became a widespread Other inputs kilometres Death the iconoclasm and Magnitude earthquake move
}
\end{table}
