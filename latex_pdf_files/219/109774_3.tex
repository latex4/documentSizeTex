...
\caption{aections de ericsson pneumatic The ia exports the country in europe in Chicagoans worked 
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Climate average government promoted active diplomacy in Radio as or work elsewh
}
\end{table}
