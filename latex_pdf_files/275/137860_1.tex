...
\end{tabular}
\end{adjustbox}
\caption{Eroded the the sky tropospheric clouds Keeping seattles scientists discover tha
}
\end{table}
...
\caption{Atmosphere and dry months Are broadcasting group radio ranc
}
\end{figure}
