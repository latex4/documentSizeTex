...
\caption{Guided rockets the urging o governor thomas jeerson drew upon In chicago asia are monsoon
}
\end{figure}
...
\centering
\includegraphics[width=0.9\columnwidth, height=0.125\paperheight]{../scenario_visualization.png}
\caption{Named san also incorporates Kingdom advertising people oten
}
\end{figure}
