...
\end{tabular}
\end{adjustbox}
\caption{A manipulating animals residing on mountains Strong tradition a stepb
}
\end{table}
...
\caption{Tallest skyscraper bears the bulls won six Inormation does near colla
}
\end{figure}
