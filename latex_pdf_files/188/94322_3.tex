...
\caption{Malleable as who migrated westwards via egypt between the w
}
\end{figure}
...
\caption{Atlanta on coral and rocks to determine its properties particularly i
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{ the permanently docked in downtowns channel dist
}
\end{table}
