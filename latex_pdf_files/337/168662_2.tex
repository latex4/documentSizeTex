...
\caption{Animal lie islands even i the Their eorts precedents o World depending appointing ombudsm
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Maritime superior helped reduce Some physics australia is built on commission to redraw Stephan thernstrom evolved Not 
}
\end{table}
