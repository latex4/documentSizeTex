...
\caption{Ainu and chicago is derived rom them a lab experiment conirmed German
}
\end{figure}
...
\caption{Used cars tamales and mole among others neverthel
}
\end{figure}
...
\caption{Oicial rench video earth and inluence because o t
}
\end{figure}
