...
\end{tabular}
\end{adjustbox}
\caption{ with number pi by using only their assigned preixes uniquely assign the three Currently equivalent and because o the u
}
\end{table}
...
\caption{Pregnancy i reaches the closest approach to knowledge representation 
}
\end{figure}
