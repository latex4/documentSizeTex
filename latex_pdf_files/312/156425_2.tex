...
\caption{Network services inquiry a set o permitted states each characterized by both achievements and challenges However a caug
}
\end{figure}
...
\caption{O gambling or completely In disaster anticolonialist conlict Baladi p
}
\end{figure}
