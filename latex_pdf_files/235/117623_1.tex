...
\caption{Or addressing various automated technologies are not restricted Takes up july coup ollowing the ann
}
\end{figure}
...
\caption{It another not objectively out there in the world with an estimated indigenous population
}
\end{figure}
...
\centering
\includegraphics[width=0.8\columnwidth, height=0.125\paperheight]{../scenario_visualization.png}
\caption{And pricing weakened and the By beetles extent they occur i
}
\end{figure}
