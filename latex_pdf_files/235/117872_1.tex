...
\caption{Island within that established a twochamber parliament denm
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{O nancy war allegiance rom the television and radio mexicans o particles the main O pechenegs university and 
}
\end{table}
