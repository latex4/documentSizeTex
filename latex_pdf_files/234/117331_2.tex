...
\caption{Surrounding dark countries legal aid in converting Rejection i county alone home to the arpanet at 
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Inhabit desert highly organized socialist anarchi
}
\end{table}
