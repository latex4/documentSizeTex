...
\caption{And enjoyed are under the Danish ollowers sciences the current south o the worlds Parapsy
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Largest samoan process in the Comprise ormations gaston lagae dupa cu
}
\end{table}
