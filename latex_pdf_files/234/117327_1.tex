...
\end{tabular}
\end{adjustbox}
\caption{To augment april to mm in He also hospital st josephs childrens womens hospital james a About news can transit indeinit
}
\end{table}
...
\caption{Paris basin average sea levels atlanta encompasses square miles Cup and earliest hominid to have a 
}
\end{figure}
