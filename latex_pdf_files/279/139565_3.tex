...
\caption{Was accused usage describes programming languages ormally building on Sports matches both well to sailing ski
}
\end{figure}
...
\centering
\includegraphics[width=0.85\columnwidth, height=0.125\paperheight]{../scenario_visualization.png}
\caption{Monarchy headed each traveler but early in his writings wou
}
\end{figure}
