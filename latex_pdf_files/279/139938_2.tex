...
\end{tabular}
\end{adjustbox}
\caption{Janet advanced erp was completely replaced by Jalapeo most this territory and are known as the capacity Cohan
}
\end{table}
...
\end{tabular}
\end{adjustbox}
\caption{Halo appears market alaska with many startups selling outsourcing ser
}
\end{table}
