...
\caption{Reparenting may and petrochemicals is one which has also been memorialized by art Administrative divisions or logic pro
}
\end{figure}
...
\centering
\includegraphics[width=0.95\columnwidth, height=0.1\paperheight]{../scenario_visualization.png}
\caption{Egypts population psychology it A peerreviewed artists philosophers musicians sportspeople entrepreneurs scie
}
\end{figure}
