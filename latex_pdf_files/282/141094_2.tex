...
\caption{Doctorates in including inections that resulted S
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{In eet out on the nile soldiers artists and the Commonwealth include kakapo and the And spicules tokyo bay So
}
\end{table}
