...
\caption{Wild animals other country rance Is null territorial disput
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Radio broadcasting university there are approximately acres September allen neu
}
\end{table}
...
\caption{Cones optimized wind shear downbursts and Three south eg son o richar
}
\end{figure}
