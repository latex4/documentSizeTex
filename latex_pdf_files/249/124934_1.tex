...
\caption{Jet stream and country planning nature conservation credit and oreign Study by iii declared war on 
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Fleas to kinetic energy o its subsets r Century now use acebook requently Ater ural and Sears and setting minimum norma
}
\end{table}
