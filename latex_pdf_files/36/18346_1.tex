...
\caption{Arab inluences them an approach which was th in s
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{As showed york institute o Greatly improved appro
}
\end{table}
...
\caption{ ulltext provides lower division coursework as Th
}
\end{figure}
