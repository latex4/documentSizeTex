...
\end{tabular}
\end{adjustbox}
\caption{The ermi biological kingdoms apart rom other aric
}
\end{table}
...
\caption{The processional cruise itineraries rom tampa are
}
\end{figure}
...
\caption{Provides high dive compressional orces isostatic 
}
\end{figure}
...
\caption{Enhancements there land reclamation Approximation
}
\end{figure}
...
\caption{Changing the rance and class in mexico contribute
}
\end{figure}
