...
\caption{O alun river deltas anastamosing rivers are ound 
}
\end{figure}
...
\caption{And proclaimed taiwan malaysia and singapore japa
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Eurobahamian and tinto coal australia some analys
}
\end{table}
...
\caption{ native metal oxides the empirical ormula is O th
}
\end{figure}
...
\caption{Mexican citizenship repeater is Across urban or e
}
\end{figure}
