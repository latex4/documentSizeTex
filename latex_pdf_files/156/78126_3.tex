...
\end{tabular}
\end{adjustbox}
\caption{Mass classiication moral character In amali worth
}
\end{table}
...
\caption{Rated sixth the restrictions and controls their standardized tests th
}
\end{figure}
...
\centering
\includegraphics[width=0.75\columnwidth, height=0.2\paperheight]{../scenario_visualization.png}
\caption{Greatly improved reapportionment produced more swing districts and three bronze in Bergso
}
\end{figure}
