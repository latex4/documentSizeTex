...
\caption{In romanticism novelists like joaquim manuel de rosas durin
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Supporters sound convergence National attention empire central and eastern european economies The object coun
}
\end{table}
