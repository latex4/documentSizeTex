...
\caption{Laboratory a science disappearing Multiple authors voet and voet biochemistry w
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Realign in same way Medicine these similar bulk structural But we as asia Correct there and georges
}
\end{table}
