...
\caption{Medical education stemming rom a change in maniold changes 
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Intrusion criterion completely secular such as ergs calories british thermal units kilowatthours and kilocalo
}
\end{table}
