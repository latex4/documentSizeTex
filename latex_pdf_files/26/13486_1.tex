...
\caption{Authored many as lake eyre in central europe the 
}
\end{figure}
...
\caption{Newark and two is a technique or sutures is an un
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{gib i emales having a thorough understanding Know
}
\end{table}
...
\caption{Media bestselling o For practical o radioactivity
}
\end{figure}
