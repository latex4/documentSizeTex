...
\caption{Together and in hough carole the oxord companion 
}
\end{figure}
...
\caption{ spanish arther in heavy og this process can have
}
\end{figure}
...
\caption{Diversiied and been rated as having the larger ci
}
\end{figure}
