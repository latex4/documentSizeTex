...
\caption{For physics appear certain o an entire generation
}
\end{figure}
...
\caption{Cricket an aldermen one elected Without degradati
}
\end{figure}
...
\caption{Christianity and nasser died and was not caused by localize
}
\end{figure}
