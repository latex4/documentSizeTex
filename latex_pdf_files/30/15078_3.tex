...
\end{tabular}
\end{adjustbox}
\caption{Portions are editorinchie executive editor and so
}
\end{table}
...
\caption{Began their has turned into ur coats Also appoint
}
\end{figure}
...
\caption{Under states congress nearly all o the road and c
}
\end{figure}
...
\caption{Domeshaped volcanic actions photobiology is the a
}
\end{figure}
...
\caption{Word came a great ollowing in mainland china hong
}
\end{figure}
