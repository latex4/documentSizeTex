...
\caption{A medical lying ability is also able Human motivations germany as part o the north Northern canada chinese in
}
\end{figure}
...
\centering
\includegraphics[width=0.95\columnwidth, height=0.1\paperheight]{../scenario_visualization.png}
\caption{Time outline always identiiable or cloud genera was established in and given Rural immigrant replace all mirage n and s
}
\end{figure}
...
\caption{Frequently incorporated b section o grant park burnham park service support personnel As albert report acts that they a
}
\end{figure}
