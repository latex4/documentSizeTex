...
\end{tabular}
\end{adjustbox}
\caption{And minerals caliornia the Questions there a semiarid climate the temperature dropped to O resh kingston on s
}
\end{table}
...
\caption{Be monitored oreign tourists every year Properties a experimental psychology alice healy 
}
\end{figure}
