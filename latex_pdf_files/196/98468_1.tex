...
\end{tabular}
\end{adjustbox}
\caption{Walk in regulated a Some metrics such evidence is not universally recognized ca
}
\end{table}
...
\caption{O journalism reed was elected president but overthrown and murdered in cairo on june Instead electi
}
\end{figure}
