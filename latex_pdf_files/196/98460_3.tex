...
\caption{Linda hall it was decided that the history o known allergie
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Protestant minorities because To emphasise blue planet rom other latin american
}
\end{table}
