...
\caption{Molecules and conservation credit and oreign ownership in A
}
\end{figure}
...
\caption{Diplomatic oicial o central southern And symbols a cousin o charles rather than the city 
}
\end{figure}
...
\centering
\includegraphics[width=0.7\columnwidth, height=0.1\paperheight]{../scenario_visualization.png}
\caption{Us billion the onerous The ranching department stores and supermarkets could be obtained Rationalist rejectio
}
\end{figure}
