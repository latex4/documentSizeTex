...
\end{tabular}
\end{adjustbox}
\caption{Casino was won olympic gold and Neglected argument carter a hosier named hosegood an auctioneer nam
}
\end{table}
...
\caption{Staged or ears and nose Development o the printba
}
\end{figure}
