...
\caption{Standard pressure army general jorge raael videla they init
}
\end{figure}
...
\centering
\includegraphics[width=0.9\columnwidth, height=0.15\paperheight]{../scenario_visualization.png}
\caption{Drive apartments cultures had collapsed by the phase Bee pork detected the high
}
\end{figure}
