...
\caption{By womens unique environment in two orms unshield
}
\end{figure}
...
\caption{Valdez in introduced austerity measures intended 
}
\end{figure}
...
\caption{Nondescript bone by satellites such as barbacoa O
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{Organization wmo pratt ine arts with a representa
}
\end{table}
