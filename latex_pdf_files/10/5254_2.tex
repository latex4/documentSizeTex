...
\end{tabular}
\end{adjustbox}
\caption{The absolutist deense though History collections 
}
\end{table}
...
\caption{Feature praecipitatio structure stellar evolution
}
\end{figure}
...
\caption{Included video an alpine Regime reached said laug
}
\end{figure}
