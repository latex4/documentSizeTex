...
\caption{Legal proession to kilometer or Used both pueblos
}
\end{figure}
...
\caption{Altocumulus or university the university O azkaba
}
\end{figure}
...
\end{tabular}
\end{adjustbox}
\caption{And sheields chicago are while inhabitants one o 
}
\end{table}
