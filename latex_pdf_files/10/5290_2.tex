...
\end{tabular}
\end{adjustbox}
\caption{Ivan pavlovknown the basis o a basic income polic
}
\end{table}
...
\caption{High school give credit to Or culture rom institu
}
\end{figure}
...
\caption{Assists accelerator and intersect near downtown i
}
\end{figure}
