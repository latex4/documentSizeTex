...
\begin{figure}[t]
\centering
\includegraphics[width=0.81\columnwidth,height=1.56in ]{MultiPlot.png} % Reduce the figure size so that it is slightly narrower than the column. Don't use precise values for figure width.This setup will avoid overfull boxes.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.9\columnwidth,height=1.54in ]{BadCreditAndFRms.jpg} % Reduce the figure size so that it is slightly narrower than the column. Don't use precise values for figure width.This setup will avoid overfull boxes.
